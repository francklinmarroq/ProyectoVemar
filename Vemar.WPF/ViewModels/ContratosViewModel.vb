...
Public Class ContratosViewModel : Inherits ViewModelBase : Implements INotifyPropertyChanged
    ...
    Public Sub New(service As IDataService(Of Contrato),
        ...
        AgregarCommand = New RelayCommand(Sub(o)
                                             ...
                                             Dim win As New AgregarContratoWindow()
                                             win.DataContext = Me
        ...
        ModificarCommand = New RelayCommand(Sub(o)
                                               ...
                                               ProyectoSeleccionado = Proyectos.FirstOrDefault(Function(x) x.Id = c.Proyecto?.Id)
                                               Dim win As New AgregarContratoWindow()
                                               win.DataContext = Me
                                               win.Owner = Application.Current.MainWindow
        ...
        Dim _reportCon As New Vemar.WPF.Reports.ContratosReport()
        ExportarExcelCommand = New RelayCommand(Sub(o)
                                                   _reportCon.GenerateExcelAsync(_itemsSource.ToList(), "Contratos")
                                               End Sub)
        ExportarPdfCommand = New RelayCommand(Sub(o)
                                                  _reportCon.GeneratePdfAsync(_itemsSource.ToList(), "Contratos")
                                              End Sub)
        ...
        _guardarCommand = New RelayCommand(AddressOf Guardar, Function(o) Not String.IsNullOrWhiteSpace(Valor) AndAlso ContratistaSeleccionado IsNot Nothing)
        ...
        _itemsView.Filter = Function(obj)
                                ...
                                Return (c.Contratista?.Nombre?.ToLower().Contains(q) OrElse
                                        c.Proyecto?.Nombre?.ToLower().Contains(q))
                            End Function
        CargarItems()
    End Sub
