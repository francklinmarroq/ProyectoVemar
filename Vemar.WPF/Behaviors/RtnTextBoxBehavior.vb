...
''' <summary>
''' Attached behavior que restringe un TextBox a 14 dígitos
''' y lo formatea visualmente como XXXX-XXXX-XXXXXX.
''' Uso XAML: b:RtnTextBoxBehavior.IsEnabled="True"
''' </summary>
Public Class RtnTextBoxBehavior
    ...
    Private Shared Sub OnIsEnabledChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        ...
        If CBool(e.NewValue) Then
            tb.MaxLength = 16  ' 14 dígitos + 2 guiones
    ...
    Private Shared Sub OnPreviewTextInput(sender As Object, e As TextCompositionEventArgs)
        ...
        If currentDigits >= 14 Then e.Handled = True
    End Sub

    ' Auto-formato XXXX-XXXX-XXXXXX
    ...
    Private Shared Sub OnTextChanged(sender As Object, e As TextChangedEventArgs)
        ...
        Dim raw = New String(originalText.Where(Function(c) Char.IsDigit(c)).Take(14).ToArray())
    ...
    Private Shared Sub OnPaste(sender As Object, e As DataObjectPastingEventArgs)
        If e.DataObject.GetDataPresent(GetType(String)) Then
            ...
            Dim digits = New String(pasted.Where(Function(c) Char.IsDigit(c)).Take(14).ToArray())
