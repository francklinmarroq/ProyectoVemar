Public Class WindowAbstractFactory : Implements IWindowAbstractFactory
    ...
    Public Sub New(detalleClienteFactory As IWindowFactory(Of DetalleClienteWindow), listadoClientesWindowFactory As IWindowFactory(Of ListadoClientesWindow))
